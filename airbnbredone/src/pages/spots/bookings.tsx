    ...
    return (
        <div className="p-6">
            ...
            <div className="flex flex-col gap-5 ">
              ...
              <img className="h-72 w-96 rounded-md hover:scale-105 hover:cursor-pointer transition duration-300 ease-in" src={spot.spotImages[0]} alt="No Image" />
              <span>{spot.location}</span>
              <div className="flex gap-5">
                <button className="border-2 border-violet-400 p-2 rounded-md hover:bg-purple-100 cursor-not-allowed">Bookings</button>
              </div>
